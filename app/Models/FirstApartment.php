...
class FirstApartment extends Model
{
    public $table='1st_apartments';
    ...
    public $type = NULL; //1st or 1st , default is NULL
    ...
    {
        return $this->belongsTo('App\Models\Court')->select('id','province','city','area','name');
    }
    ...
    {
        return $this->belongsTo('App\Models\User','agent_id')->select('id','mobile','is_agent');
    }

    public function agentt()
    {
        return $this->belongsTo('App\Models\User','user_id')->select('id','mobile','is_agent');
    }
    ...
    private function getAll() {
        ...
        (!empty($this->saleOrRental) and $this->type == '1st') && $builder->where('sale_or_rental', $this->saleOrRental);
