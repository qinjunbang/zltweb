...
class SecondApartment extends Model
{
    public $table='2nd_apartments';
    ...
    {
        return $this->morphToMany('App\Models\User', 'favorable', 'favorites');
    }

    public function court()
    {
        return $this->belongsTo('App\Models\Court')->select('id','province','city','area','name','pp','ave_price');
    }
    ...
    {
        return $this->belongsTo('App\Models\User','agent_id')->select('id', 'mobile', 'name','is_agent')->where('is_agent',1);
    }

    public function userer()
    {
        return $this->belongsTo('App\Models\User','user_id')->select('id', 'mobile', 'name','is_agent');
    }

    public function userBeAppointed() {
        return $this->morphToMany('App\Models\User', 'appointmentable', 'appointments', 'appointmentable_id');
    }
