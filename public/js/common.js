...
document.write('<script src="'+path+'jquery/dist/jquery.js"></sc'+'ript>');
document.write('<script src="'+path+'iconfont/iconfont.js"></sc'+'ript>');
document.write('<script src="'+path+'jquery-weui/dist/js/jquery-weui.js"></sc'+'ript>');
